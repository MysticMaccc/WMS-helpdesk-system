<section>
    <div
        class="p-3 sm:px-8 relative h-screen lg:overflow-hidden bg-primary xl:bg-white dark:bg-darkmode-800 xl:dark:bg-darkmode-600 
        before:hidden before:xl:block before:content-[''] before:w-[57%] before:-mt-[28%] before:-mb-[16%] before:-ml-[13%] before:absolute 
        before:inset-y-0 before:left-0 before:transform before:rotate-[-4.5deg] before:bg-sky/20 before:rounded-[100%] before:dark:bg-darkmode-400 
        after:hidden after:xl:block after:content-[''] after:w-[57%] after:-mt-[20%] after:-mb-[13%] after:-ml-[13%] after:absolute after:inset-y-0 after:left-0 
        after:transform after:rotate-[-4.5deg] after:bg-sky-400 after:rounded-[100%] after:dark:bg-darkmode-700">
        <div class="container relative z-10 sm:px-10">
            <div class="block grid-cols-2 gap-4 xl:grid">
                <!-- BEGIN: Login Info -->
                <div class="hidden min-h-screen flex-col xl:flex">
                    <a class="-intro-x flex items-center pt-5" href="">
                        <img class="w-20" src="{{ asset('storage/system/DPI.png') }}"
                            alt="Midone - Tailwind Admin Dashboard Template">
                        <span class="ml-3 text-xl font-bold text-gray-900"> Help Desk System</span>
                    </a>
                    <div class="my-auto">
                        <img class="-intro-x -mt-16 w-1/2" src="{{ asset('dist/images/illustration.svg') }}"
                            alt="Midone - Tailwind Admin Dashboard Template">
                        <div class="-intro-x mt-10 text-4xl font-medium leading-tight text-gray-900">
                            A few more clicks to <br>
                            sign in to your account.
                        </div>
                        <div class="-intro-x mt-5 text-lg text-gray-800 text-opacity-70 dark:text-slate-400">
                            Manage all your support request in one place
                        </div>
                    </div>
                </div>
                <div class="my-10 flex h-screen py-5 xl:my-0 xl:h-auto xl:py-0">
                    <div
                        ...
                        <div class="intro-x text-slate-400">
                            A few more clicks to sign in to your account. Manage all your support request in one place.
                        </div>
                        ...
                        <form wire:submit.prevent="logInAuthenticate">
                            ...
                            <div class="intro-x mt-1">
                                ...
                                <x-input data-tw-merge="" label="Password" wireModel="password" placeholder="Password"
                        ...
                        @if ($showModal)
                            <div data-tw-backdrop="static" aria-hidden="{{ $showModal }}" tabindex="-1"
                                ...
                                @if ($showModal) style="margin-top: 0px; margin-left: 0px; padding-left: 0px; z-index: 10000;" @endif>
                                    ...
                                    <div class="flex flex-col">
                                        <div class="items-center justify-center">
                                            ...
                                            <div class="justify-center mt-3">
                                                <input type="text" wire:model='enteredOTP' name="" autofocus
                                                    id=""
